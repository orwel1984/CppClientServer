...
There is an IServer and IClient interface which enforces the design constraints above. The more specialised clients and servers like UDP or TCP will support more specialized implementations of their concrete classes.
